...
const Events = () => {
  ...
  const categories = ["All", "Community", "Professional Development", "Fundraising", "Student Support"];
      ...
      <section className="events-page" style={{ padding: "50px 0" }}>
        <div className="container">
          <div className="page-header" style={{ marginBottom: "40px", textAlign: "center" }}>
            <h1 style={{ color: "var(--color-primary)", marginBottom: "20px" }}>UMMAA Events</h1>
            <p style={{ color: "var(--color-text)", fontSize: "18px", maxWidth: "600px", margin: "0 auto" }}>
              Join us for networking events, professional development sessions, community celebrations, 
              and opportunities to give back to the next generation of Muslim students.
            </p>
          </div>

          {/* Category Filter */}
          <div className="category-filter" style={{ marginBottom: "40px", textAlign: "center" }}>
            ...
            {filteredEvents.map((event) => (
              ...
              >
                ...
                <div className="event-content" style={{ padding: "25px" }}>
                  ...
                  <div className="event-registration" style={{ 
                    display: "flex", 
